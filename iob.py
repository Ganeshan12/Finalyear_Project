...
mm= ar_master_iob.master_flask_code()
class iob:
    def __init__(self):
        ...
        self.text_color = '#FFF'
        self.backround_image = 'images/background_hd3.jpg'
    ...
    def iob_login(self):
        ...
        image = Image.open('images/background_hd3.jpg')
    ...
    def user_home(self, account_no):
        ...
        bg = ImageTk.PhotoImage(file='images/background_hd3.jpg')
    ...
    def user_deposit(self,account_no):
        ...
        self.bg = ImageTk.PhotoImage(file='images/background_hd3.jpg')
