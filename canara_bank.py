...
mm= ar_master_canara.master_flask_code()
class canra_bank:
    def __init__(self):
        self.master = 'ar_master'
        self.title = 'Canara Bank'
        self.titlec = 'CANARA BANK'
        self.backround_color = '#2F4F4F'
        self.text_color = '#FFF'
        self.backround_image = 'images/background_hd1_canara.jpg'
